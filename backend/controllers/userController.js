...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (userExists) {
    res.status(400) // client err - user did something wrong
...
//
// Check if the new email is already registered, verify its format using the validator package
// (e.g., ensuring "@" and "." are present), and confirm if the ID matches the userID.
